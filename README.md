...
- There are 1185665 transcript chunks to be processed individually to reduce the hallucinations .
- Since there are this much transcript chunks, i cannot just slap on a search onto this transcript data.
- So i am taking a different approach of processing these chunks via a LLM to filter the chunks where human names exists. shrinking the necessary search space.